class Question {
  ...
  display() {
    ...
    this.question.html(
      "Ouestion: First lady president of India ?"
    );
    this.question.position(150, 80);
    this.option1.html("1: Indira Gandhi ");
    this.option1.position(150, 100);
    this.option2.html("2: Pratibha Patil");
    this.option2.position(150, 120);
    this.option3.html("3: Nirmala Sitharaman ");
    this.option3.position(150, 140);
    this.option4.html("4: Sucheta Kripalani");
